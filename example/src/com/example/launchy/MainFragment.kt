...
class MainFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<MultiSelectListPreference>("launchPermissions")!!.bindSummary({ values }) {
            it.joinToString(", ") { getActualString(it, R.array.permission_values, R.array.permissions) }
        }
    }
